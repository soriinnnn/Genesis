...
ImageTexture::ImageTexture(const ImageTextureDesc& tdesc, const GraphicsResourceDesc& gdesc): GraphicsResource(gdesc)
{
...
D3D11_SHADER_RESOURCE_VIEW_DESC getShaderResourceViewDesc(const ScratchImage& imageData)
{
