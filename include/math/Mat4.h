...
namespace genesis
{
	...
	public:
		...
		static Mat4 orthographicLH(float width, float height, float near, float far) noexcept;
		static Mat4 orthographicOffCenterLH(float left, float right, float bottom, float top, float near, float far) noexcept;
